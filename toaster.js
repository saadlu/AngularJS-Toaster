(function () {
     ...
     *
     * Modified to fix a potential bug - mmia
     */
    ...
    angular.module('toaster', ['ngAnimate'])
        ...
        .service('toaster', ['$rootScope', 'toasterConfig', function ($rootScope, toasterConfig) {
            ...
            function makeTypeFunction(type){
                return (function (toasterType) {
            ...
            for (var type in toasterConfig['icon-classes']) {
                this[type] = makeTypeFunction(type);
            }
        }])
        .factory('toasterRegisterEvents', function () {
            ...
            return {
                ...
                reset: toasterFactory.reset
            };
        })
        .directive('toasterContainer',
        ['$parse', '$rootScope', '$interval', '$sce', 'toasterConfig', 'toaster', 'toasterRegisterEvents',
                            ...
                            if ($scope.config.tap === true || isCloseButton === true) {
                                ...
                                if (toaster.clickHandler) {
                                    if (angular.isFunction(toaster.clickHandler)) {
                                        ...
                                        removeToast =
                                            $scope.$parent.$eval(toaster.clickHandler)(toaster, isCloseButton);
                                    }
                                    else {
